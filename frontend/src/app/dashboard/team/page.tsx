                  ...
                  {canManage && !m.is_you && m.role !== "owner" && editingRoleFor !== m.id && (
                    <>
                      <button
                        ...
                        title="Editar papel"
                        className="p-2.5 -m-1 rounded text-text-tertiary hover:text-text-primary hover:bg-surface-3 transition-colors"
                      >
                        <Pencil size={13} />
                      </button>
                      <button
                        ...
                        className="p-2.5 -m-1 rounded text-text-tertiary hover:text-danger hover:bg-danger-muted transition-colors disabled:opacity-50"
                      >
